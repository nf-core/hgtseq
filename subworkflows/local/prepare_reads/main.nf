...
workflow PREPARE_READS {
    ...
    if (aligner == "bwa-mem") {
        ...
        bwaindex      = fasta_meta ? params.bwaindex      ? Channel.fromPath(params.bwaindex).collect()      : BWAMEM1_INDEX.out.index : []
        ...
        bwamem2index  = fasta_meta ? params.bwamem2index  ? Channel.fromPath(params.bwamem2index).collect()  : BWAMEM2_INDEX.out.index : []
