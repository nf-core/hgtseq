...
workflow PREPARE_READS {
    ...
    if (aligner == "bwa-mem") {
        ...
        bwaindex      = fasta_meta ? bwaindex      ? Channel.fromPath(params.bwaindex).collect()      : BWAMEM1_INDEX.out.index : []
        ...
        bwamem2index  = fasta_meta ? bwamem2index  ? Channel.fromPath(params.bwamem2index).collect()  : BWAMEM2_INDEX.out.index : []
