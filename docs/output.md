...
[`SAMtools`](https://www.htslib.org) Extracting reads by sam flag (single unmapped and both unamapped)
...
[`Kraken2`](https://github.com/DerrickWood/kraken2/blob/master/docs/MANUAL.markdown) Converting reads to fastq format, to accomodate kraken2 input requirements
